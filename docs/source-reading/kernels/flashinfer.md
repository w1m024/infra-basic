...
- Route connection: Serving-oriented attention, sampling and communication kernels.
...
| local path | `vendor/flashinfer-ai/flashinfer` |
| commit | `c15ac84` |
...
|---|---|---|---|
| `vendor/flashinfer-ai/flashinfer/flashinfer/__init__.py` | entry/config | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/flashinfer-ai/flashinfer/flashinfer/__main__.py` | core state | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/flashinfer-ai/flashinfer/flashinfer/activation.py` | core state | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/flashinfer-ai/flashinfer/flashinfer/aot.py` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/flashinfer-ai/flashinfer/flashinfer/api_logging.py` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/flashinfer-ai/flashinfer/flashinfer/artifacts.py` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/flashinfer-ai/flashinfer/flashinfer/attention/__init__.py` | resource/test | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/flashinfer-ai/flashinfer/flashinfer/attention/_core.py` | resource/test | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/flashinfer-ai/flashinfer/flashinfer/attention/cute_dsl/__init__.py` | resource/test | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/flashinfer-ai/flashinfer/flashinfer/attention/cute_dsl/fmha.py` | resource/test | File exists in current checkout | Track call boundary, state mutation, and error handling |
...
```bash
git submodule update --init --depth 1 vendor/flashinfer-ai/flashinfer
git -C vendor/flashinfer-ai/flashinfer rev-parse --short HEAD
```
...
- Upstream repository: https://github.com/flashinfer-ai/flashinfer
