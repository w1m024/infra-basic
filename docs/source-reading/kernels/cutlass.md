...
- Route connection: CUDA template primitives for GEMM and tensor core kernels.
...
| local path | `vendor/NVIDIA/cutlass` |
| commit | `93774d3` |
...
|---|---|---|---|
| `vendor/NVIDIA/cutlass/include/cutlass/aligned_buffer.h` | entry/config | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/NVIDIA/cutlass/include/cutlass/arch/arch.h` | core state | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/NVIDIA/cutlass/include/cutlass/arch/barrier.h` | core state | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/NVIDIA/cutlass/include/cutlass/arch/cache_operation.h` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/NVIDIA/cutlass/include/cutlass/arch/config.h` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/NVIDIA/cutlass/include/cutlass/arch/grid_dependency_control.h` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/NVIDIA/cutlass/include/cutlass/arch/memory.h` | resource/test | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/NVIDIA/cutlass/include/cutlass/arch/memory_sm75.h` | resource/test | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/NVIDIA/cutlass/include/cutlass/arch/memory_sm80.h` | resource/test | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/NVIDIA/cutlass/include/cutlass/arch/mma.h` | resource/test | File exists in current checkout | Track call boundary, state mutation, and error handling |
...
```bash
git submodule update --init --depth 1 vendor/NVIDIA/cutlass
git -C vendor/NVIDIA/cutlass rev-parse --short HEAD
```
...
- Upstream repository: https://github.com/NVIDIA/cutlass
