...
- Layer: agent-runtime.
- Route connection: Agent CLI comparison with visible source scope noted.
...
| local path | `vendor/anthropics/claude-code` |
| commit | `ca9f604` |
...
|---|---|---|---|
| `vendor/anthropics/claude-code/.claude-plugin/marketplace.json` | entry/config | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/anthropics/claude-code/.claude/commands/commit-push-pr.md` | core state | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/anthropics/claude-code/.claude/commands/dedupe.md` | core state | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/anthropics/claude-code/.claude/commands/triage-issue.md` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/anthropics/claude-code/.devcontainer/Dockerfile` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
...
```bash
git submodule update --init --depth 1 vendor/anthropics/claude-code
git -C vendor/anthropics/claude-code rev-parse --short HEAD
```
