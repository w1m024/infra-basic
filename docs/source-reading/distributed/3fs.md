...
- Route connection: AI workload file system and storage layer comparison.
...
| 字段 | 值 |
|---|---|
| upstream | https://github.com/deepseek-ai/3FS |
| local path | `vendor/deepseek-ai/3FS` |
| commit | `22fca04` |
...
|---|---|---|---|
| `vendor/deepseek-ai/3FS/.clang-format` | entry/config | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/deepseek-ai/3FS/.clang-tidy` | core state | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/deepseek-ai/3FS/.clangd` | core state | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/deepseek-ai/3FS/.dockerignore` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/deepseek-ai/3FS/.github/workflows/build-dev-docker-image.yml` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
...
```bash
git submodule update --init --depth 1 vendor/deepseek-ai/3FS
git -C vendor/deepseek-ai/3FS rev-parse --short HEAD
```
...
- Upstream repository: https://github.com/deepseek-ai/3FS
