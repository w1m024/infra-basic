...
- Route connection: Distributed serving orchestration comparison.
...
| local path | `vendor/ai-dynamo/dynamo` |
| commit | `462a605` |
...
|---|---|---|---|
| `vendor/ai-dynamo/dynamo/.agents/contributor-skills/debug-session/SKILL.md` | entry/config | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/ai-dynamo/dynamo/.agents/contributor-skills/dep-create/SKILL.md` | core state | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/ai-dynamo/dynamo/.agents/contributor-skills/dep-status/SKILL.md` | core state | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/ai-dynamo/dynamo/.agents/contributor-skills/dep-update/SKILL.md` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/ai-dynamo/dynamo/.agents/contributor-skills/dynamo-clone-hotpath-audit/SKILL.md` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
...
```bash
git submodule update --init --depth 1 vendor/ai-dynamo/dynamo
git -C vendor/ai-dynamo/dynamo rev-parse --short HEAD
```
...
- Upstream repository: https://github.com/ai-dynamo/dynamo
