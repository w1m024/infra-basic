...
- Layer: cache-system.
- Route connection: KV cache reuse/offload layer.
...
| local path | `vendor/LMCache/LMCache` |
| commit | `93aee5e` |
...
|---|---|---|---|
| `vendor/LMCache/LMCache/.buildkite/README.md` | entry/config | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/LMCache/LMCache/.buildkite/cases/comprehensive-cases.txt` | core state | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/LMCache/LMCache/.buildkite/cases/integration-cases.txt` | core state | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/LMCache/LMCache/.buildkite/configs/async.yaml` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/LMCache/LMCache/.buildkite/configs/dummy.yaml` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
...
```bash
git submodule update --init --depth 1 vendor/LMCache/LMCache
git -C vendor/LMCache/LMCache rev-parse --short HEAD
```
