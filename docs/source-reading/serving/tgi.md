# Text Generation Inference source reading
...
- Route connection: Production Rust/Python serving stack comparison.
...
| local path | `vendor/huggingface/text-generation-inference` |
| commit | `b4adbf2` |
...
|---|---|---|---|
| `vendor/huggingface/text-generation-inference/.dockerignore` | entry/config | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/huggingface/text-generation-inference/.github/ISSUE_TEMPLATE/bug-report.yml` | core state | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/huggingface/text-generation-inference/.github/ISSUE_TEMPLATE/config.yml` | core state | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/huggingface/text-generation-inference/.github/ISSUE_TEMPLATE/feature-request.yml` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/huggingface/text-generation-inference/.github/ISSUE_TEMPLATE/new-model-addition.yml` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
...
```bash
git submodule update --init --depth 1 vendor/huggingface/text-generation-inference
git -C vendor/huggingface/text-generation-inference rev-parse --short HEAD
```
...
- Upstream repository: https://github.com/huggingface/text-generation-inference
