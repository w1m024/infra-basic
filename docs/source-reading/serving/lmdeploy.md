...
- Route connection: TurboMind and PyTorch engine comparison.
...
| local path | `vendor/InternLM/lmdeploy` |
| commit | `9b3b193` |
...
|---|---|---|---|
| `vendor/InternLM/lmdeploy/.clang-format` | entry/config | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/InternLM/lmdeploy/.claude/skills/docker-build/SKILL.md` | core state | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/InternLM/lmdeploy/.claude/skills/support-new-model/SKILL.md` | core state | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/InternLM/lmdeploy/.dockerignore` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
| `vendor/InternLM/lmdeploy/.github/CONTRIBUTING.md` | execution loop | File exists in current checkout | Track call boundary, state mutation, and error handling |
...
```bash
git submodule update --init --depth 1 vendor/InternLM/lmdeploy
git -C vendor/InternLM/lmdeploy rev-parse --short HEAD
```
